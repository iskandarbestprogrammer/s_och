...
<div class="container">
 ...
 <input type="email" class="form-control" id="log" placeholder="E-mail">
 ...
 <button type="submit" id="b1" class="btn btn-default">ВХОД</button>
 <button type="submit"  class="btn btn-default"> <a href="sp/sp_reg_form.php" class="text-white">Регистрация</a> </button>
 </div>
 </form>
 </div>
